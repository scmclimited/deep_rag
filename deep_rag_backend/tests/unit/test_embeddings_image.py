...
class TestEmbedImage:
    ...
    def test_embed_image_with_path_string(self, mock_get_model):
    ...
    @patch('ingestion.embeddings.image.get_clip_model')
    def test_embed_image_with_pathlib_path(self, mock_get_model):
    ...
    @patch('ingestion.embeddings.image.get_clip_model')
    def test_embed_image_with_pil_image(self, mock_get_model):
    ...
    def test_embed_image_with_normalization(self, mock_normalize, mock_get_model):
    ...
    @patch('ingestion.embeddings.image.get_clip_model')
    def test_embed_image_without_normalization(self, mock_get_model):
    ...
    @patch('ingestion.embeddings.image.get_clip_model')
    def test_embed_image_encoding_failure(self, mock_get_model):
