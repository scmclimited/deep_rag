# diagnostics.py
"""
Diagnostic functions to inspect what chunks and pages are stored in the database.
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        print_inspection_report(doc_title=doc_title)
    else:
        print_inspection_report()  # Show all documents
